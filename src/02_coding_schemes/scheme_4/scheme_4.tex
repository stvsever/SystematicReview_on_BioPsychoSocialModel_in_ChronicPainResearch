...
\item \filepath{src/06_review_stages/04_extraction/forms/stage3_manual_relevance_checklist.csv}
\item \filepath{src/06_review_stages/04_extraction/outputs/stage3_candidate_manifest.csv}
\item \filepath{src/06_review_stages/04_extraction/outputs/stage3_manual_fulltext_queue.csv}
\item \filepath{src/06_review_stages/04_extraction/outputs/stage3_retrieval_validation.csv}
\end{itemize}
