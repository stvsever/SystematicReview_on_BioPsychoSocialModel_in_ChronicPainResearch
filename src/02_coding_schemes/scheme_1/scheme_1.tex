...
\item \filepath{src/09_review_stages/03_screening/README.md}
...
\begin{itemize}
\item \filepath{src/09_review_stages/03_screening/outputs/stage1_screening.csv}
\item \filepath{src/09_review_stages/03_screening/audit/stage1_screening_summary.csv}
\item \filepath{src/09_review_stages/03_screening/audit/reliability_report.csv}
\end{itemize}
