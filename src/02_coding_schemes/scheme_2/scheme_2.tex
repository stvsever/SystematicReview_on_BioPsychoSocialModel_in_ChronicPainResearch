...
\item \filepath{src/09_review_stages/04_extraction/codebooks/stage2_codebook.csv}
...
\item \filepath{src/09_review_stages/04_extraction/outputs/stage2_abstract_coding.csv}
\item \filepath{src/09_review_stages/04_extraction/outputs/stage2_llm_structured_coding.csv}
\item \filepath{src/09_review_stages/04_extraction/outputs/llm_stage2_structured_batches.jsonl}
\end{itemize}
...
\begin{itemize}
\item \filepath{src/09_review_stages/04_extraction/outputs/stage2_abstract_coding.csv}
\item \filepath{src/09_review_stages/04_extraction/forms/stage2_double_code_subset.csv}
\item \filepath{src/09_review_stages/04_extraction/outputs/stage2_objective_llm_assist.csv}
\item \filepath{src/09_review_stages/04_extraction/outputs/llm_objective_pilot.json}
\end{itemize}
