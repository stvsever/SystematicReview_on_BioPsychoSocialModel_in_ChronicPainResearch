...
\section*{Proposed Refinement: Explicit Retrieval-Adequacy Gate}
\refbadge
...
\section*{Test-Run Corpus State}
{\small\itshape Counts from the current test run, for context only.}\par\smallskip
\begin{description}
\item[Stage 2 included records] 111
\item[Stage 3 candidate manifest] 92
\item[Manual full-text queue] 63
\item[Reliability subset (capped at 20)] 18
\end{description}
